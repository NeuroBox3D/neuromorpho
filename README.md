...
This Python wrapper depends only on the Python 2 respectively Python 3 standard libraries, so no additional dependencies are required to run it, except that Python >= 2.6 is required.
